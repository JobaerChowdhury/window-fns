...
queries = [
    ...
    FROM CountryRevenue;
    """,
    # 8. Rank customers by spend in country
    """
    ...
    FROM NewSessions;
    """,
    # 13. Compare to previous row (WoW)
    """
    ...
    FROM Ranked;
    """,
    # 15. Top performing day per country
    """
    ...
    """,
    # 19. Running balance / cumulative sum
    """
